...
browser.find_element(By.ID, "firstName").send_keys("Hieu")
browser.find_element(By.ID, "lastName").send_keys("Mino")
browser.find_element(By.ID, "userEmail").send_keys("hieu99213@donga.com")
...
browser.execute_script("document.getElementById('dateOfBirthInput').value = '20 Jan 2003'")
